...
<html>
    ...
    <body>
        ...
        <!-- issue form  -->
  <form action="searchForIssue" method="post">
    <div class="issueTitle">ISSUE BOOK</div>

    <c:if test="${not empty studentFound}" >
                    <p class="bookAdded">${studentFound}</p>
                    <c:remove var="studentFound" scope="session" />
                </c:if>
                <c:if test="${not empty studentNotAdded}" >
                    <p class="bookFailed">${studentNotAdded}</p>
                    <c:remove var="studentNotAdded" scope="session" />
                </c:if> 
    
    <div class="bookStudentContainer">
      <div class="bookDetails">
        <div class="formGroup">
            <div class="formGroupText">ISBN </div> <input id="form-search-book" type="text" name="BookISBN" value="<%=books.getISBN()%>">
      ...
      <div class="studentDetails">
        <div class="formGroup">
          ...
          <button type="submit" class="searchIssueButtons" ><i id="searchBookButton" class="fa-solid fa-magnifying-glass"></i></button>
        </div>
        <div class="formGroup">
