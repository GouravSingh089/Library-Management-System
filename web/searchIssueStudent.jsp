<%-- 
    Document   : searchIssueStudent
    Created on : 26 Mar, 2022, 10:12:30 PM
    Author     : Gourav
--%>
...
<html>
    ...
    <body>
        ...
        <!--getting book details-->
         <% 
            String bid = request.getParameter("isbn");
            BooksDao booksDao = new BooksDao();
            Books books = booksDao.getBookByIsbn(bid);
            
            String enroll = request.getParameter("enrollment");
            Students students = new Students();
            StudentsDao studentsDao = new StudentsDao();
            students = studentsDao.getStudentsByEnroll(enroll);
        %>
  ...
  <form action="" method="post">
    ...
    <div class="bookStudentContainer">
      ...
      <div class="studentDetails">
        ...
        <div class="formGroup">
          <div class="formGroupText">First Name</div> <input type="text" name="firstName" value="<%=students.getFirstName() %>" >
        </div>
        <div class="formGroup">
          <div class="formGroupText">Last Name</div> <input type="text" name="lastName"  value="<%=students.getLastName() %>" >
        </div>

        <div class="formGroup">
          <div class="formGroupText">Programme</div> <input type="text" name="programme"  value="<%=students.getProgramme() %>" >
        </div>
        <div class="formGroupSmall">
          <div class="formGroupText">Semester</div> <input type="text" name="semester"  value="<%=students.getSemester() %>" >
          <div class="formGroupTextBatch">
            <div>Batch</div><input type="text" name="batch"  value="<%=students.getBatch() %>" >
          </div>
        </div>
      </div>
    </div>
